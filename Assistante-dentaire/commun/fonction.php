...
<td colspan="2"><fieldset style="width:95%; align:left; border: 1px solid #06442a; padding: 10px;">
...
// La session est ouverte dans connect.php
function formulaire($AffConnect) {

global $email, $pass, $connect, $administrateur, $txt_mem, $txt_VoCompt, $txt_deconnect, $HTTP_USER_AGENT, $txt_Vemail, $txt_pass, $geo ;
...
<input type="text" class="rt" size="25" maxlength="120" name="email" />
<input type="password" class="rt" size="15" maxlength="120" name="pass" />
...
<input type="text" class="rt" size="30" maxlength="120" name="email"/>
</p>
<p><label>'.$txt_pass.' :</label>
<input type="password" class="rt" size="25" maxlength="120" name="pass" />
</p>
...
echo '
<fieldset style="width:90%; align:left; border: 1px solid #06442a; padding: 10px;">
<legend style="color: #FFFFFF; background: #06442a; font-size: 8pt; padding: 5px; margin: 5px 5px 5px 5px;"><strong>'.$txt_Pub.' :</strong></legend>
<center>
<div style="border: 1px solid #000000; text-align: center; width: 270pt; background: #660032; font-family: Verdana; font-size: 11pt; color: #FFFFFF">
<br /><strong>Les journ&eacute;es de l\'installation <br /> et de l\'association en lib&eacute;ral 2012 : <br /><br />';
...
echo $jour.' '.date_naturelle($row["date"]).' &agrave; '.$row["ville"].'<br /> ';

};


echo '<br /></strong></div></center>



<br />
<div style="border: 1px solid #000000; text-align: center; width: 270pt; background: #d86d81; font-family: Verdana; font-size: 11pt; color: #000000">
Pour que l\'installation <br />ne soit plus un casse-t&ecirc;te !
<img src="images/JI_Paris.jpg" border="1" width="270" height="180" /></div>
<br /><br />
<div style="font-family: Verdana; font-size: 10pt; color: #5d0336">

Une journ&eacute;e pour aborder tous les aspects de l\'installation et de l\'association.<br />
<br />
<strong>Programme :</strong><br />
&#149; Etude de march&eacute; - g&eacute;omarketing <br />
&#149; Aides &agrave; l\'installation <br />
&#149; Modes d\'exercice (SCM, SCP, SEL, ...)
et incidences &eacute;conomiques <br />
&#149; Formalit&eacute;s et obligations (personnelles,
en tant qu\'employeur et d\'am&eacute;nagement
du cabinet) <br />
&#149; Budget pr&eacute;visionnel et financement  <br />
&#149; Assurance et couverture sociale   <br />
&#149; Postes cl&eacute;s de la 2035<br />
</div>


<br /><br />
<center><a href="index.php?cat=jinstall&amp;lien=inscription"><font class="ButtonRose">S\'inscrire</font></a></center>
